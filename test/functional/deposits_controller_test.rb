...
class DepositsControllerTest < ActionController::TestCase
  ...
  test "should create deposit" do
    assert_difference('Deposit.count') do
      post :create, deposit: { date: @deposit.date, lot_number_id: @deposit.lot_number_id, plant_id: @deposit.plant_id, qty_bank: @deposit.qty_bank, qty_consigned: @deposit.qty_consigned }
    end
  ...
  test "should update deposit" do
    put :update, id: @deposit, deposit: { date: @deposit.date, lot_number_id: @deposit.lot_number_id, plant_id: @deposit.plant_id, qty_bank: @deposit.qty_bank, qty_consigned: @deposit.qty_consigned }
    assert_redirected_to deposit_path(assigns(:deposit))
  end
