...
class CatalogsControllerTest < ActionController::TestCase
  ...
  test "should create catalog" do
    assert_difference('Catalog.count') do
      post :create, catalog: { lot_number_id: @catalog.lot_number_id, plant_id: @catalog.plant_id, qty_in_bank: @catalog.qty_in_bank, qty_on_consignment: @catalog.qty_on_consignment }
    end
  ...
  test "should update catalog" do
    put :update, id: @catalog, catalog: { lot_number_id: @catalog.lot_number_id, plant_id: @catalog.plant_id, qty_in_bank: @catalog.qty_in_bank, qty_on_consignment: @catalog.qty_on_consignment }
    assert_redirected_to catalog_path(assigns(:catalog))
  end
