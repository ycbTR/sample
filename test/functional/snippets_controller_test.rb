...
class SnippetsControllerTest < ActionController::TestCase
  ...
  test "should create snippet" do
    assert_difference('Snippet.count') do
      post :create, snippet: { content: @snippet.content, excerpt: @snippet.excerpt, identifier: @snippet.identifier, label: @snippet.label, slug: @snippet.slug }
    end
  ...
  test "should update snippet" do
    put :update, id: @snippet, snippet: { content: @snippet.content, excerpt: @snippet.excerpt, identifier: @snippet.identifier, label: @snippet.label, slug: @snippet.slug }
    assert_redirected_to snippet_path(assigns(:snippet))
  end
