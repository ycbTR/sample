class Admin::DepositsController < Admin::BaseController
  ...
  def create
    ...
    respond_to do |format|
      if @deposit.save
        format.html { redirect_to admin_deposits_path, notice: 'Deposit was successfully created.' }
  ...
  def update
    ...
    respond_to do |format|
      if @deposit.update_attributes(params[:deposit])
        format.html { redirect_to admin_deposits_path, notice: 'Deposit was successfully updated.' }
