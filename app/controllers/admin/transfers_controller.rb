class Admin::TransfersController < Admin::BaseController
  ...
  def create
    ...
    respond_to do |format|
      if @transfer.save
        format.html { redirect_to admin_transfers_path, notice: 'Transfer was successfully created.' }
  ...
  def update
    ...
    respond_to do |format|
      if @transfer.update_attributes(params[:transfer])
        format.html { redirect_to admin_transfers_path, notice: 'Transfer was successfully updated.' }
