class Admin::SnippetsController < Admin::BaseController
  ...
  def create
    ...
    respond_to do |format|
      if @snippet.save
        format.html { redirect_to admin_snippets_url, notice: 'Snippet was successfully created.' }
  ...
  def update
    ...
    respond_to do |format|
      if @snippet.update_attributes(params[:snippet])
        format.html { redirect_to admin_snippets_url, notice: 'Snippet was successfully updated.' }
