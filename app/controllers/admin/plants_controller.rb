class Admin::PlantsController < Admin::BaseController
  ...
  def create
    ...
    respond_to do |format|
      if @plant.save
        format.html { redirect_to admin_plants_url, notice: 'Plant was successfully created.' }
  ...
  def update
    ...
    respond_to do |format|
      if @plant.update_attributes(params[:plant])
        format.html { redirect_to admin_plants_url, notice: 'Plant was successfully updated.' }
