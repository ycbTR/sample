class Admin::LotNumbersController < Admin::BaseController
  # GET /lot_numbers
  ...
  def create
    ...
    respond_to do |format|
      if @lot_number.save
        format.html { redirect_to admin_lot_numbers_path, notice: 'Lot number was successfully created.' }
  ...
  def update
    ...
    respond_to do |format|
      if @lot_number.update_attributes(params[:lot_number])
        format.html { redirect_to admin_lot_numbers_path, notice: 'Lot number was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to admin_lot_numbers_path }
      format.json { head :no_content }
    end
  end
end
